...
public class SliderSize extends GuiButton
{
    ...
    public void updateText()
    {
        ...
        {
            this.displayString = "" + Color.c + "a" + (ConfigManager.settings.size + 50) + "%";
        }
        else
        {
            this.displayString = ConfigManager.settings.size + 50 + "%";
        }
    }
    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            this.drawTexturedModalRect(this.getX() + (int)((double)((float)(ConfigManager.settings.size * 100) / this.valueMax) * 0.72D), this.getY(), 0, 66, 4, 20);
            this.drawTexturedModalRect(this.getX() + (int)((double)((float)(ConfigManager.settings.size * 100) / this.valueMax) * 0.72D) + 4, this.getY(), 196, 66, 4, 20);
        }
    }
