...
public class GuiMultiplayer extends GuiMenuScreen implements GuiYesNoCallback
{
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(this.refresh = new GuiButton(8, this.width / 2 + 4, this.height - 28, 70, 20, I18n.format("selectServer.refresh", new Object[0])));
        this.buttonList.add(new GuiButton(0, this.width / 2 + 4 + 76, this.height - 28, 75, 20, I18n.format("gui.cancel", new Object[0])));
        this.selectServer(this.serverListSelector.func_148193_k());
        this.refresh.enabled = !LabyMod.getInstance().refresh;
        this.buttonList.add(new GuiButton(10, this.width - 55, 4, 50, 20, "Account"));

        if (ConfigManager.settings.betterRefresh)
        {
            this.buttonList.add(new GuiButton(9, this.width - 83 - 52, 4, 78, 20, Color.booleanToColor(Boolean.valueOf(LabyMod.getInstance().refresh)) + "Auto Refresh"));
        }
        else
        {
