...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(201, this.width / 2 + 5, this.height / 6 + 25 - 6, 150, 20, I18n.format("LabyMod Settings", new Object[0])));
        ...
        if (ModManager.getSettings().size() != 0)
        {
            ...
            this.buttonList.add(new GuiButton(202, this.width / 2 - 155, this.height / 6 + 25 - 6, 150, 20, I18n.format("Mod Settings (" + ModManager.getSettings().size() + " Mod" + s + ")", new Object[0])));
        }
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new GuiModSettings(this, this.game_settings_1));
            }

            if (button.id == 202)
            {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new GuiCompModSettings(this));
            }
        }
    }
