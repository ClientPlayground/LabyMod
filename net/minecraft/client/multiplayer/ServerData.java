...
public class ServerData
{
    ...
    public NBTTagCompound getNBTCompound()
    {
        ...
        nbttagcompound.setString("command", this.serverCommand);
    ...
    {
        ServerData serverdata = new ServerData(nbtCompound.getString("name"), nbtCompound.getString("ip"), false, nbtCompound.getString("command"));
