...
public class TextureManager implements ITickable, IResourceManagerReloadListener
{
    ...
    private HashMap<String, ITextureObject> storedTextures = new HashMap();
    ...
    public void bindTexture(ResourceLocation resource)
    {
        ...
        if (itextureobject != null && itextureobject != TextureUtil.missingTexture && !this.storedTextures.containsKey(resource.getResourcePath()))
        {
            this.storedTextures.put(resource.getResourcePath(), itextureobject);
        }
        else if ((itextureobject == null || itextureobject == TextureUtil.missingTexture) && this.storedTextures.containsKey(resource.getResourcePath()))
        {
            ITextureObject itextureobject1 = (ITextureObject)this.storedTextures.get(resource.getResourcePath());

            if (itextureobject1 != null && itextureobject1 != TextureUtil.missingTexture)
            {
                Minecraft.getMinecraft().getTextureManager().loadTexture(resource, itextureobject1);
                System.out.println("[TextureManager] Reload texture " + resource.getResourcePath());
            }
        }
